...
namespace ProjetoCarLocadora.Front.Controllers
{
    public class UsuarioController : Controller
    {
        public ActionResult Index(string mensagem = null, bool sucesso = true)
        {
            ...
            HttpResponseMessage response = client.GetAsync($"https://localhost:7035/api/Usuario").Result;
        ...
        public ActionResult Details(string valor)
        {
            ...
            HttpResponseMessage response = client.GetAsync($"https://localhost:7035/api/Usuario/ObterDadosUsuario?cpf={valor}").Result;
            ...
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    */
                    ...
                    HttpResponseMessage response = client.PostAsJsonAsync($"https://localhost:7035/api/Usuario", usuarioModel).Result;
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    */
                    ...
                    HttpResponseMessage response = client.PutAsJsonAsync($"https://localhost:7035/api/Usuario", usuarioModel).Result;
        ...
        public ActionResult Delete(string valor)
        {
            ...
            HttpResponseMessage response = client.DeleteAsync($"https://localhost:7035/api/Usuario?cpf={valor}").Result;
            if (response.IsSuccessStatusCode)
            {
