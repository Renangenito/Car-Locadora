...
namespace ProjetoCarLocadora.Front.Controllers
{
    public class VeiculoController : Controller
    {
        ...
        public async Task<ActionResult> Details(string valor)
        {
            ...
            HttpResponseMessage response = await client.GetAsync($"{_dadosBase.Value.API_URL_BASE}Veiculo/ObterDadosVeiculo?placa={valor}");
        ...
        [HttpPost]
        public async Task<ActionResult> Create([FromForm] VeiculoModel veiculoModel)
        {
            ...
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    HttpResponseMessage response = await client.PostAsJsonAsync($"{_dadosBase.Value.API_URL_BASE}Veiculo", veiculoModel);
        ...
        [HttpPost]
        public async Task<ActionResult> Edit([FromForm] VeiculoModel veiculoModel)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    HttpResponseMessage response = await client.PutAsJsonAsync($"{_dadosBase.Value.API_URL_BASE}Veiculo", veiculoModel);
        ...
        public async Task<ActionResult> Delete(string valor)
        {
            ...
            HttpResponseMessage response = await client.DeleteAsync($"{_dadosBase.Value.API_URL_BASE}Veiculo?placa={valor}");
            if (response.IsSuccessStatusCode)
            {
